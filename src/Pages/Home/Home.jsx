...
import { GetUserContext } from "../../Store/user-store.js";
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      if (currentUser !== null) {
        await currentUserId(currentUser.id, isAuth);
      } else {
        return;
      }
    })();
  ...
  return (
    <>
      ...
      {/* <div className="text-center">
        <h1 className="text-4xl items-center align-middle mt-[8rem] font-extrabold h-screen">
          Welcome To Our Website
        </h1>
      </div> */}
      <div class="container mx-auto px-6 py-16 pt-[15rem] text-center ">
        <div class="mx-auto max-w-lg">
          <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-500 md:text-4xl">
            Create beautiful website layout with US.
          </h1>

          <p class="mt-6 text-gray-500 dark:text-gray-500">
        ...
        <div class="mx-auto mt-[10rem] max-w-screen-xl">
          <div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
            <div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
              <svg
                class="h-12 fill-current text-gray-500 dark:text-gray-500"
            ...
            <div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
              <svg
                class="h-10 fill-current text-gray-500 dark:text-gray-500"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
              <svg
                class="mt-2 h-8 fill-current text-gray-500 dark:text-gray-500"
                viewBox="0 0 398 120"
                xmlns="http://www.w3.org/2000/svg"
              >
                <g fill-rule="nonzero">
            ...
            <div class="col-span-1 flex items-center justify-center md:col-span-3 lg:col-span-1">
              <svg
                class="mt-1 h-5 fill-current text-gray-500 dark:text-gray-500"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-span-2 flex items-center justify-center md:col-span-3 lg:col-span-1">
              <svg
                class="h-8 fill-current text-gray-500 dark:text-gray-500"
